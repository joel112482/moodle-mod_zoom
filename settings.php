...
if ($ADMIN->fulltree) {
    ...
    $defaultauthusersoption = new admin_setting_configcheckbox('mod_zoom/defaultauthusersoption', get_string('option_auth_users', 'mod_zoom'),
            '', 0, 1, 0);
    $settings->add($defaultauthusersoption);

    $defaultmuteonentryoption = new admin_setting_configcheckbox('mod_zoom/defaultmuteonentryoption', get_string('option_mute_on_entry', 'mod_zoom'),
            '', 1, 1, 0);
    $settings->add($defaultmuteonentryoption);
}
