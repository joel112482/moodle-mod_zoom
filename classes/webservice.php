...
class mod_zoom_webservice {
    ...
    protected function _database_to_api($zoom) {
        ...
        if (isset($zoom->option_auth_users)) {
            $data['settings']['meeting_authentication'] = (bool) $zoom->option_auth_users;
        }
        ...
        if ($zoom->webinar) {
            ...
            $data['settings']['join_before_host'] = isset($zoom->option_jbh);
            $data['settings']['waiting_room'] = isset($zoom->option_waiting_room);
            if (isset($zoom->option_mute_on_entry)) {
                $data['settings']['mute_upon_entry'] = (bool) ($zoom->option_mute_on_entry);
            }
        }
